 ...
 * @author Marcus
 */
public class bcMedico extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bcMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
