 ...
 * @author aluno
 */
public class pacienteOptions extends javax.swing.JFrame {

    /**
     * Creates new form ErrorMsg
     */
    public pacienteOptions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Alterar Dados de Paciente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pacienteOptions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pacienteOptions().setVisible(true);
            }
        });
    }
